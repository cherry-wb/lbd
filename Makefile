...
# Custom
GH_PAGES_SOURCES = code_fragment Fig source Table terminal_io LLVMBackendTutorialExampleCode Makefile
...
html:
	$(SPHINXBUILD) -b html $(ALLSPHINXOPTS) $(BUILDDIR)/${LANG}/html
	@echo
